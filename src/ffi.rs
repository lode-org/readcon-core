...
fn map_builder_err(e: crate::error::ParseError) -> RKRStatus {
    ...
    match e {
        ...
        ParseError::MassMismatch { .. } => RKRStatus::RKR_STATUS_VALIDATION_ERROR,
...
/// symbol but disagree on mass ([`crate::error::ParseError::MassMismatch`];
...
mod tests {
    ...
    fn test_frame_handle() -> *mut RKRConFrame {
        ...
        Box::into_raw(Box::new(builder.build().unwrap())) as *mut RKRConFrame
    }
    #[test]
