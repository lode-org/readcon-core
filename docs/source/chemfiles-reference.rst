...
.. table::
    ...
    +--------------------------------------------+-------------------------------------------------------------------------------------------+
    | ``python_wheels.yml`` matrix ``chemfiles`` | PyPI ``readcon-chemfiles`` (Windows: prebuilt libchemfiles + ``advapi32``)                 |
    +--------------------------------------------+-------------------------------------------------------------------------------------------+
    | ``c_lib_tarball.yml``                      | ``readcon-core-clib-$VER-$target`` on Linux/macOS; Windows + chemfiles is an explicit skip |
    +--------------------------------------------+-------------------------------------------------------------------------------------------+
