...
*Diátaxis: **explanation** (understanding). Not a procedure — for steps see `tutorial <chemfiles-tutorial.rst>`_ and `how-to <chemfiles-howto.rst>`_.*

1 Why drive conversion from other formats at all?
-------------------------------------------------
...
2 Why is chemfiles optional (Cargo feature + two PyPI names)?
-------------------------------------------------------------
...
3 Why bonds live in frame JSON, not ``sections``
------------------------------------------------
...
4 Index spaces: chemfiles order vs ``atom_data`` vs ``atom_id``
---------------------------------------------------------------
...
5 What selection does under the hood
------------------------------------
