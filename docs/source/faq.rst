...
Equal-geometry (``benches/multiformat_traj.py``, ``rgam5terra`` 2026-07-08, 100×218
atoms, median of 5): **readcon CON 2.55 ms** vs ASE plain XYZ **26.7 ms** (10.5×),
ASE extXYZ 26.8 ms (10.5×), ASE CON 30.5 ms (12×). Same host CON-peer run
(``compare_readers.py``): ASE CON 30.6 ms, C sscanf 7.3 ms, readcon file **3.3 ms**
(9.2× ASE, 2.2× C). Tables and re-run recipes: `benchmarks <benchmarks.rst>`_ ·
`migrate <migrate.rst>`_.
