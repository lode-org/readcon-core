...
| C ABI tarball | =c_lib_tarball.yml= | GitHub Release | Attach prebuilt libreadcon_core + headers + pkg-config |
...
10. Verify all distribution channels:
    ...
    - [[https://github.com/lode-org/readcon-core/releases][GitHub Releases]] has cargo-dist CLI archives,
