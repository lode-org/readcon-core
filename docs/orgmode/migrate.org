...
|------------+-------------------------------------|
| Indexed corpora | Energy, formula, section-presence flags from the same projection as [[https://docs.rs/readcon-core/latest/readcon_core/index_proj/][=index_proj=]] |
...
| Campaign store | [[https://github.com/lode-org/readcon-db][readcon-db]] · [[https://lode-org.github.io/readcon-db/][docs]] · [[https://docs.rs/readcon-db][docs.rs]] |
