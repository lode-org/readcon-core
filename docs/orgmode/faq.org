...
Runnable walk-throughs (enable feature, XYZ→CON, =angles: all=, C probe) live
in =docs/orgmode/tutorials.org= under *Chemfiles multi-format converter* and
*Bond and angle selection*. Binding matrix and documented gaps are in
