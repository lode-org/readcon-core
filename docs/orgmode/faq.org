...
[[https://docs.rs/readcon-core/latest/readcon_core/index_proj/][index_proj]]
...
[[file:migrate.org][migrate.org]] (=readcon-core convert=,
=readcon.convert_to_con=).

| Component | Job |
|-----------+-----|
| CON on disk | The checkpoint format (text, optional gzip/zstd) |
| =readcon-core= | Frame API + hourglass ABI + chemfiles in + selection + compression + DLPack/metatensor ([[https://docs.rs/readcon-core][docs.rs]]) |
| =readcon-db= | Campaign LMDB: energy / formula / section indexes, dedup, multi-reader ([[https://lode-org.github.io/readcon-db/][docs]] · [[https://docs.rs/readcon-db][docs.rs]]) |
...
| [[https://omnipotentrpc.github.io/rgpot/][rgpot]] / [[https://eondocs.org][eOn]] | Optimizers and potentials on the same CON files |
...
Package docs: [[https://lode-org.github.io/readcon-db/][lode-org.github.io/readcon-db]].
Rust API: [[https://docs.rs/readcon-db][docs.rs/readcon-db]].
Source: [[https://github.com/lode-org/readcon-db][github.com/lode-org/readcon-db]].
...
How-to: [[file:migrate.org][migrate.org]], [[file:chemfiles-tutorial.org][chemfiles-tutorial]].
