...
rankings as library headlines. Full methodology: [[file:benchmarks.org][benchmarks]].
...
when inputs originate elsewhere. See [[file:benchmarks.org][benchmarks.org]]
...
implementation and =readcon-db= is the *state-of-the-art stack this project
implements* and measures against ASE XYZ/CON under equal-geometry protocols
([[file:benchmarks.org][benchmarks.org]]). ASE remains appropriate for
