...
@@rst::cite:t:`chillEONSoftwareLong2014`@@.
...
| H5MD (@@rst::cite:t:`deBuylH5MDStructuredEfficient2014`@@) | HDF5 layout for continuous MD trajectories and observables |
...
| metatensor (@@rst::cite:t:`bigiMetatensorMetatomicFoundational2026`@@) | ML tensor graphs; =readcon-core= can export =TensorBlock= / DLPack |
...
(@@rst::cite:t:`deBuylH5MDStructuredEfficient2014`@@).
