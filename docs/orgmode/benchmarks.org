...
=benches/make_plots.py= when preparing a paper or major release — plots still
embed some format “estimates” for chemfiles XYZ/GRO that are not measured
ingress through =readcon-chemfiles=.
