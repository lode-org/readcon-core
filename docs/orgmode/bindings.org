...
- =readcon.ConFrame= :: Constructable with cell, angles, atoms, and
  ...
  atoms, has_velocities, has_forces, prebox_header, postbox_header,
  spec_version (v0.6.0+), metadata (v0.6.0+, dict of native
  JSON-compatible values), energy, frame_index, time, timestep,
  neb_bead, neb_band.
...
- =ReadCon.ConFrame= :: cell, angles, atoms, has_velocities,
  has_forces, prebox_header, postbox_header
