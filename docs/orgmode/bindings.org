...
| Positions-only batch (no full Atom list) | via SoA on ~ConFrame~ | ~readcon.read_all_positions~ | n/a | n/a | n/a | n/a |
...
.. tab-set::
   ...
   .. tab-item:: Python
      ...
      .. code-block:: python
         ...
         # is unnecessary (see also count_frames, read_all_positions, iter_con).
