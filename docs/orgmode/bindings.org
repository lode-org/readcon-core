...
- =readcon.ConFrame= :: Constructable with cell, angles, atoms, and
  ...
  (v0.6.0+), metadata (v0.6.0+, dict of extra JSON keys), energy,
  frame_index, time, timestep, neb_bead, neb_band.
...
rkr_frame_builder_set_energy(builder, -42.5);
rkr_frame_builder_set_frame_index(builder, 7);
