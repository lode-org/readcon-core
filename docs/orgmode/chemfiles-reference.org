...
| =python_wheels.yml= matrix =chemfiles= | PyPI =readcon-chemfiles= (Windows x86_64: prebuilt libchemfiles + =advapi32=) |
| =c_lib_tarball.yml= | GitHub Release =readcon-core-clib-*= (Linux/macOS lean; no Windows, no chemfiles) |
