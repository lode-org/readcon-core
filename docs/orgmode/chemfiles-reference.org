...
| =c_lib_tarball.yml= matrix =default= | GitHub Release =readcon-core-clib-*-default.tar.gz= |
| =c_lib_tarball.yml= matrix =chemfiles= | GitHub Release =readcon-core-clib-*-chemfiles.tar.gz= (Windows chemfiles uses official prebuilt libchemfiles, not from-sources) |
