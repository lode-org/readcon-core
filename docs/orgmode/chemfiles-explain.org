...
/Diátaxis: *explanation* (understanding). Not a procedure — for steps see
...
=tests/selection.cpp= are not fully mirrored. See [[file:bindings.org][bindings]] and
[[file:chemfiles-reference.org][reference]] for the supported subset.
