...
# Python: default PyPI wheel has stubs (has_chemfiles_support() is False).
# Optional extra documents the full source install (empty deps; enables intent):
MATURIN_PEP517_ARGS="--features python,chemfiles" pip install ".[chemfiles]"
# or editable:
