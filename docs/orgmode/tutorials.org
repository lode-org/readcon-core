...
if (rkr_frame_add_atom(builder, "Cu", 0.0, 0.0, 0.0,
                       false, 1, 63.546) != RKR_STATUS_SUCCESS) {
    free_rkr_frame_builder(builder);
    return 1;
}
if (rkr_frame_add_atom(builder, "Cu", 2.55, 2.55, 0.0,
                       false, 2, 63.546) != RKR_STATUS_SUCCESS) {
    free_rkr_frame_builder(builder);
    return 1;
}
