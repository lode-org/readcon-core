...
| Measured speed | CI Cachegrind I-refs + equal-geometry harnesses vs ASE CON and C sscanf—see [[file:benchmarks.org][benchmarks.org]] |
...
Design *why* and format evolution: [[file:architecture.org][architecture.org]],
[[file:evolution.org][evolution.org]], [[file:faq.org][faq.org]], [[file:spec.org][spec.org]].
Speed evidence and methodology: [[file:benchmarks.org][benchmarks.org]].
