...
|---------+---------+-------------|
| Python CON I/O | =pip install 'readcon==0.14.1'= | [[https://pypi.org/project/readcon/][PyPI]] |
| Python + chemfiles | =pip install 'readcon-chemfiles==0.14.1'= | [[https://pypi.org/project/readcon-chemfiles/][PyPI]] (do not mix with lean =readcon= in the same venv) |
