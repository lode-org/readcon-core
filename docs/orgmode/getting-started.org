...
| Parse regressions and peer ordering | Cachegrind + equal-geometry benches ([[file:benchmarks.org][benchmarks.org]]) |
...
Design and format evolution: [[file:architecture.org][architecture.org]],
[[file:evolution.org][evolution.org]], [[file:faq.org][faq.org]], [[file:spec.org][spec.org]].
Speed methodology: [[file:benchmarks.org][benchmarks.org]].
