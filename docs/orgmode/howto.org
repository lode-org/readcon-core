...
#+description: Task recipes for CON read/write across languages (Diátaxis how-to).
...
#+begin_src julia
# Prebuilt cargo-c prefix from the GitHub Release
ENV["READCON_CORE_PREFIX"] = "/path/to/readcon-core-clib-0.14.7-x86_64-unknown-linux-gnu-chemfiles"
# or pin the file:
...
- Tutorial: [[file:chemfiles-tutorial.org][chemfiles-tutorial.org]]
- How-to: [[file:chemfiles-howto.org][chemfiles-howto.org]]
- Explanation: [[file:chemfiles-explain.org][chemfiles-explain.org]]
- Reference: [[file:chemfiles-reference.org][chemfiles-reference.org]]
