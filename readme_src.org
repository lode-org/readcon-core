...
- *Bindings:* Python (PyO3), Julia (ccall), C (committed header), C++ (RAII header), Fortran (fpm); hourglass ABI patterned on [[https://github.com/metatensor/metatensor][metatensor]].
...
- *Hourglass FFI:* C header plus a hand-written C++ RAII wrapper, same pattern as [[https://github.com/metatensor/metatensor][metatensor]]. CMake FetchContent, Meson wrap, and =readcon-core.pc= do not run cbindgen.
