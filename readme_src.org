...
- *Speed:* =rgam5terra= 2026-07-08, 100×218 full load: native CON *2.27 ms* vs ASE =.traj= *11.4 ms* (5×), ASE NetCDF *30.1 ms* (13×), ASE multi-frame XYZ *27.2 ms* (12×); =readcon.read_chemfiles= XYZ→CON *14.1 ms*. CON peers also beat ASE CON / C sscanf. See [[file:docs/orgmode/benchmarks.org][benchmarks]]
