...
- *Campaigns:* Pair with [[https://github.com/lode-org/readcon-db][readcon-db]] (CON-text indexes, dedup, multi-reader).
...
[[https://lode-org.github.io/readcon-db/][readcon-db docs]]. Plotting:
...
| Campaigns | =index_proj= + [[https://github.com/lode-org/readcon-db][readcon-db]] (energy/formula/sections indexes, dedup) |
