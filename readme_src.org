...
- *Speed:* on =rgam5terra= 2026-07-08, =benches/compare_readers.py= 100×218 CON: readcon file path 3.3 ms vs ASE =ase.io.eon= 30.6 ms (9.2×) and eOn-style C sscanf 7.3 ms (2.2×); CI Cachegrind tracks I-refs (see [[file:docs/orgmode/benchmarks.org][benchmarks]])
