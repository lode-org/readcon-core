...
| Julia | unpack =readcon-core-clib-*= + =READCON_CORE_PREFIX= (or in-tree build) | [[file:docs/orgmode/bindings.org][bindings]] |
| Fortran | unpack =readcon-core-clib-*= + =PKG_CONFIG_PATH= (fpm) | [[file:fortran/README.md][fortran/README]] |
...
| C ABI prefix | =readcon-core-clib-$VERSION-$TARGET.tar.gz= on the GitHub Release | same (prebuilt; not cargo-dist) |
