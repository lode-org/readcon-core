...
- *Speed:* =rgam5terra= 2026-07-08, 100×218 equal geometry: ASE multi-frame XYZ *26.8 ms*, =readcon.read_chemfiles= (XYZ→CON) *13.3 ms* (2.0× ASE), native CON *2.5 ms* (10.6× ASE); CON peers also beat ASE CON / C sscanf (=compare_readers.py=). See [[file:docs/orgmode/benchmarks.org][benchmarks]]
