...
- *Campaigns:* [[https://github.com/lode-org/readcon-db][readcon-db]] indexes CON text (energy / formula / sections, dedup, multi-reader)
- *Plotting:* [[https://chemparseplot.rgoswami.me][chemparseplot]] (+ [[https://rgpycrumbs.rgoswami.me][rgpycrumbs]]) on CON checkpoints / paths — not a per-code export
