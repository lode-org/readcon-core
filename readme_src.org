...
| Ingress | Optional chemfiles import/selection into =ConFrame= |
| Campaigns | =index_proj= screening for [[https://github.com/lode-org/readcon-db][readcon-db]] (=cargo add readcon-db=, =pip install readcon-db=) |
