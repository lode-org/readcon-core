...
| Corpora | =index_proj= + [[https://github.com/lode-org/readcon-db][readcon-db]] (=cargo add= / =pip install=; [[https://lode-org.github.io/readcon-db/docs/][docs]]) |
...
- *Corpora:* Pair with [[https://github.com/lode-org/readcon-db][readcon-db]] (CON-text indexes, dedup, multi-reader; [[https://lode-org.github.io/readcon-db/docs/][docs]]).
...
- *Corpora:* [[https://github.com/lode-org/readcon-db][readcon-db]] on CON text (energy / formula / sections, dedup, multi-reader; [[https://lode-org.github.io/readcon-db/docs/][docs]])
...
[[file:docs/orgmode/chemfiles-notebook.org][chemfiles-notebook]]. Corpora:
[[https://lode-org.github.io/readcon-db/docs/][readcon-db docs]]. Plotting:
...
| readcon-db | =cargo add readcon-db= / =pip install readcon-db= | [[https://lode-org.github.io/readcon-db/docs/][docs]] |
...
| Corpora | =index_proj= + [[https://github.com/lode-org/readcon-db][readcon-db]] ([[https://lode-org.github.io/readcon-db/docs/][docs]]) |
