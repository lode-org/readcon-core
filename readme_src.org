...
- *Speed:* equal-geometry on =rgam5terra= 2026-07-08 (=multiformat_traj.py=, 100×218): readcon CON *2.55 ms* vs ASE plain XYZ *26.7 ms* (10.5×) and ASE CON 30.5 ms (12×); CON peers (=compare_readers.py=): 3.3 ms vs ASE CON 30.6 ms (9.2×) and C sscanf 7.3 ms (2.2×). CI Cachegrind: [[file:docs/orgmode/benchmarks.org][benchmarks]]
